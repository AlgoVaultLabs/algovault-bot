...
WELCOME_MESSAGE: Final = (
    ...
    "/scan [RANK] [TOP_N] [TF] [EXCH]    — one-shot scan (RANK: oi/vol/gain/lose/move/pfr/nfr)\n"
...
HELP_MESSAGE: Final = (
    ...
    "/scan [RANK] [TOP_N] [TF] [EXCH] — one-shot scan; RANK lens oi(default)/volume/gainers/losers/movers/funding_positive/funding_negative (aliases vol/gain/lose/move/pfr/nfr)\n"
