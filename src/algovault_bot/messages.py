...
WELCOME_MESSAGE: Final = (
    ...
    "/scan [RANK] [TOP_N] [TF] [EXCH]    — one-shot scan (RANK: oi/vol/gain/lose/move/pfr/nfr/atr)\n"
...
HELP_MESSAGE: Final = (
    ...
    "/scan [RANK] [TOP_N] [TF] [EXCH] — one-shot scan; RANK lens oi(default)/volume/gainers/losers/movers/funding_positive/funding_negative/volatility (aliases vol/gain/lose/move/pfr/nfr/atr)\n"
